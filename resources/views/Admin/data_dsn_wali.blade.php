...
<body>
    <x-layout_admin> 
        <div class="flex-1 p-6">
            <div class="mt-4">
                <p class="text-gray-600"><i class="ri-user-fill"></i> Data Dosen</p>
                <h2 class="text-2xl font-bold">Dosen Wali <span class="text-gray-600 text-sm">Informasi Data Dosen.</span></h2>
            </div>
