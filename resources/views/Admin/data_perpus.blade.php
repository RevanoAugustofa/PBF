...
<head>
    ...
    <title>Data Koordinator Perpustakaan</title>
</head>
<style>
...
<body>
    <x-layout_admin> 
        <div class="flex-1 p-6">
            <div class="mt-4">
                <p class="text-gray-600"><i class="ri-user-fill"></i> Data Koordinator Perpustakaan</p>
                <h2 class="text-2xl font-bold">Koordinator Perpustakaan <span class="text-gray-600 text-sm">Informasi Data Koor Perpustakaan.</span></h2>
            </div>
            <div class="bg-white p-4 rounded shadow mt-4">
                <!-- Tab Menu -->
                <div class="flex justify-between items-center border-b pb-2">
                    <div class="flex space-x-4">
                        <button class="px-4 py-2 border-b-4 border-blue-500 font-semibold">Data Perpustakaan</button>
                    </div>
                    ...
                    <table id="myTable" class="display table table-striped" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th>Nama Koordinator Perpustakaan</th>
                                <th>ID User</th>
                                <th>Aksi</th>
                            </tr>
                        </thead>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            fetch("http://localhost:8080/koorperpus") 
                ...
                .then(data => {
                    ...
                    data.forEach((koor, index) => {
                        let row = `<tr>
                            <td>${index + 1}</td>
                            <td>${koor.id_koor}</td>
                            <td>${koor.nama_koor_perpus}</td>
                            <td>${koor.id_user}</td>
